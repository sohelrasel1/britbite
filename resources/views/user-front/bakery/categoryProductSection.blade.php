                        ...
                        <div class="tab-pane slide {{ $keys == 0 ? 'show active' : '' }}" id="{{ $category->slug }}">
                                                        ...
                                                        <div class="product text-center p-40 rounded-circle mb-25">
                                                            ...
                                                            <div class="product-details">
                                                                ...
                                                                <div class="product-price">
                                                                    <span class="h6 font-sm new-price color-primary"
                                                                        dir="ltr">{{ $userBe->base_currency_symbol_position == 'left' ? $userBe->base_currency_symbol : '' }}{{ convertUtf8($product->current_price) }}
                                                                        {{ $userBe->base_currency_symbol_position == 'right' ? $userBe->base_currency_symbol : '' }}</span>
                            ...
                            <div class="cta-btn text-center mt-15">
                                <a href="{{ route('user.front.items', [getParam(), 'category_id' => $category->id]) }}"
                                    ...
                                    title="{{ $keywords['View All Items'] ?? __('View All Items') }}"
