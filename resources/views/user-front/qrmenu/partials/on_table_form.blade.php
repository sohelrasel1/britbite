...
<div class="row">
    <div class="col-12">
        <div class="form billing-info">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="field-label">{{$keywords['Name'] ?? __('Name')}} *</div>
                ...
                @endphp
                <div class="col-md-6">
                    <div class="field-label">{{$keywords['Table Number'] ?? __('Table Number')}} *</div>
                    <div class="field-input">
                ...
                <div class="col-md-6">
                    <div class="field-label">{{$keywords["Waiter Name"] ?? __('Waiter Name')}}</div>
                    <div class="field-input">
