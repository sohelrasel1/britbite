                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="book-btn text-center mt-20">
                                            <button class="main-btn main-btn-2" id="booking"
...
<script>
    $('#booking').submit(function() {
        ...
        mobile = formData.get('{{ $input->name }}');
        phone = phone.replace("+", "");
        ...
        // window.location.href = 'https://wa.me/+447849619979?text=Name:%20'+name+'%0AEmail:%20'+email+'%0AMobile:%20'+mobile+'%0ADate:%20'+date+'%0ATime:%20'+time+'%0AGuest:%20'+guest;
