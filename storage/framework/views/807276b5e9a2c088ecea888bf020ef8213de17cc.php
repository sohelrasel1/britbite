    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="changeNextPackageForm" action="<?php echo e(route('user.nextPackage.change')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="package_id" id="" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($package->id); ?>" <?php echo e(!empty($nextPackage) && $nextPackage->id == $package->id ? 'selected' : ''); ?>><?php echo e($package->title); ?> (<?php echo e($package->term); ?>)</option>
...
<?php /**PATH G:\BritBite-Company-England\britbite-git\britbite\resources\views/admin/register_user/edit-next-package.blade.php ENDPATH**/ ?>