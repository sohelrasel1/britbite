<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Mail To Admin')); ?></h4>
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                <div class="alert alert-warning text-center" role="alert">
                    <strong><?php echo e(__('This mail addres will be used to receive all mails from clients / buyers / inquirier.')); ?></strong>
                </div>
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\BritBite-Company-England\britbite-git\britbite\resources\views/admin/basic/email/mail_to_admin.blade.php ENDPATH**/ ?>