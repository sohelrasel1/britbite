    ...
    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">
                                        <?php echo e(ProductOrder::query()->where('user_id', $user->id)->count()); ?>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="card card-stats card-primary card-round">
                <!-- <a href="<?php echo e(route('user.member.index')); ?>" class="text-decoration-none"> -->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-5">
                                <div class="icon-big text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    ...
                                    <h4 class="card-title">
                                        <?php echo e(Subscriber::query()->where('user_id', $user->id)->count()); ?>
                ...
                <a href="<?php echo e(route('user.table.index')); ?>"
                    ...
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-7 col-stats">
                                <div class="numbers">
                                    <p class="card-category">Tables & QR Builder</p>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\BritBite-Company-England\britbite-git\britbite\resources\views/user/dashboard.blade.php ENDPATH**/ ?>