                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!-- <span
                                                            ...
                                                            <span class="price">
                                                                ...
                                                                <?php echo e($package->price == 0 ? 'Free' : $package->price); ?>

                                                                <?php echo e($package->price != 0 && $be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol : ''); ?>

                                                            </span>
                                                            <s class="price">
                                                                <?php echo e($package->package_discount != 0 && $be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol : ''); ?>

                                                                <?php echo e($package->package_discount != 0 ? $package->package_discount : ''); ?> <!-- Add this line to display the discount -->
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\BritBite-Company-England\britbite-git\britbite\resources\views/front/pricing.blade.php ENDPATH**/ ?>